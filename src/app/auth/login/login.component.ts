...
export class LoginComponent implements OnInit {
  ...
  password: any;
  loginFailedStatus ="";
  customerToken="objerrt=!vx456"
  user:User = {firstName: "SetNext Admin",lastName:""} as User;
  //#endregion sdasd
  ...
  onLoginSubmit(data: any) {
    ...
    if(data.userName.trim()=="admin@setnext.io" && data.password.trim()=="admin")
    {
      ...
      this.localStore.saveData('customerInfo', JSON.stringify(this.user),ObjectType.json, true);
